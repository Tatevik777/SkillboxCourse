...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            double TFC= income*officeRentCharge;
            double TVC = income-telephonyCharge-financeManagerSalary-assistantSalary-telephonyCharge;
            double breakEvenPoint= TFC/TVC;
            System.out.println("Точка безубыточности равна " + breakEvenPoint);
